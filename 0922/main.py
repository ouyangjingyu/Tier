...
def load_dataset(args):
    ...
    elif args.dataset == "fashion_mnist" or args.dataset == "cifar10":
    ...
    for round_idx in range(args.rounds):
        ...
        try:
            ...
            metrics = {
                ...
                "distillation/partition_alpha": args.partition_alpha
            }
